    ...
    <main className="min-h-screen bg-[#F4F7FB] text-[#071B4D]">
      <section className="px-6 py-12 md:px-10 lg:px-16">
        <div className="mx-auto flex max-w-[1200px] justify-center">
          <div className="flex min-h-[560px] flex-col justify-between overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-[#071B4D] via-[#0A2463] to-[#071B4D] p-8 text-white shadow-[0_28px_90px_rgba(7,27,77,0.28)] md:p-10">
            <div>
            ...
            <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
              <Link
                ...
                className="inline-flex h-14 items-center justify-center rounded-2xl bg-white px-6 text-sm font-black text-[#071B4D] shadow-xl shadow-black/15 transition hover:-translate-y-0.5 hover:bg-cyan-50"
              >
            ...
            {!showInsights ? (
              <form className="grid grid-cols-1 gap-4">
                  ...
                  <label className="block">
                    ...
                    <div className="relative">
                      <select
                        ...
                        className="h-13 w-full appearance-none rounded-2xl border border-blue-100 bg-blue-50/30 px-4 py-4 pr-12 text-sm font-bold text-[#071B4D] outline-none transition placeholder:text-slate-400 focus:border-blue-500 focus:bg-white focus:ring-4 focus:ring-blue-50"
                      >
                ...
                <div className="mt-6 flex flex-col gap-3 sm:flex-row">
                  ...
                  <Link
                    href="/verkopen/schatting"
                    className="flex-1 rounded-2xl border border-slate-200 bg-white px-5 py-4 text-center text-sm font-black text-[#071B4D] shadow-lg shadow-blue-900/10 transition hover:-translate-y-0.5 hover:bg-slate-50"
                  >
              ...
              <div className="grid grid-cols-1 gap-4">
                ...
                <button
                  ...
                  className="mt-2 inline-flex h-14 items-center justify-center rounded-2xl border border-slate-200 bg-white px-6 text-sm font-black text-[#071B4D] shadow-lg shadow-blue-900/10 transition hover:-translate-y-0.5 hover:bg-slate-100"
                >
                  Sluiten
                </button>
              </div>
      ...
      <section className="px-6 pb-14 md:px-10 lg:px-16">
        ...
        <div className="mx-auto mt-8 max-w-[1400px] rounded-[2rem] border border-blue-100 bg-white p-6 shadow-[0_18px_55px_rgba(15,23,42,0.08)] md:p-8">
          <div className="grid gap-6 md:grid-cols-[1fr_auto] md:items-center">
            ...
            <a
              href="#waardebepaling"
              className="inline-flex h-12 items-center justify-center rounded-2xl bg-[#071B4D] px-5 text-sm font-black text-white shadow-lg shadow-blue-900/15 transition hover:-translate-y-0.5 hover:bg-[#0B2A6B]"
            >
              Inzicht starten
            </a>
          </div>
        ...
        <div className="mx-auto mt-8 max-w-[1400px] rounded-[2rem] border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <div className="mt-4 space-y-5 text-justify text-base font-medium leading-8 text-slate-600">
            <p>
              Een woning verkopen begint niet bij de advertentie, maar bij een goede voorbereiding. Verzamel eerst je woninggegevens, documenten, EPC-informatie, foto’s en eventuele renovatiegegevens. Zo krijg je een beter beeld van de sterke punten van je woning en van aandachtspunten die kopers belangrijk kunnen vinden.
            </p>
            <p>
              Daarna bepaal je een realistische vraagprijs op basis van vergelijkbare woningen, ligging, staat, oppervlakte en marktinformatie. Een duidelijke presentatie helpt om de juiste kopers aan te trekken: goede foto’s, een volledige beschrijving en transparante informatie over energie, comfort en onderhoud maken je woning betrouwbaarder.
            </p>
            <p>
              Wanneer geïnteresseerden reageren, volgen bezichtigingen, vragen, onderhandelingen en eventueel een bod. Na akkoord worden de afspraken vastgelegd en begeleidt de notaris de juridische afhandeling. Tot slot worden bij de akte de betaling, documenten en sleuteloverdracht geregeld.
            </p>
            <p>

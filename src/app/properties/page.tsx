                ...
                <div className="w-[330px] shrink-0 px-4 py-3.5 lg:w-[380px]">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-2">
                    <button
                      ...
                      className="inline-flex whitespace-nowrap rounded-full border border-blue-200 bg-blue-50 px-3 py-1.5 text-sm font-bold leading-none text-blue-700 transition hover:bg-blue-100"
                    >
                      Analyse
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex whitespace-nowrap rounded-full border border-green-200 bg-green-50 px-3 py-1.5 text-sm font-bold leading-none text-green-700 transition hover:bg-green-100"
                    >
                      Energie
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex whitespace-nowrap rounded-full border border-orange-200 bg-orange-50 px-3 py-1.5 text-sm font-bold leading-none text-orange-700 transition hover:bg-orange-100"
                    >
                      Renovatie
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex whitespace-nowrap rounded-full border border-amber-200 bg-amber-50 px-3 py-1.5 text-sm font-bold leading-none text-amber-700 transition hover:bg-amber-100 disabled:cursor-not-allowed disabled:opacity-50"
                    >

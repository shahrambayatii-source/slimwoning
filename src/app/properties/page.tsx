          ...
          {sortedProperties.map((property) => {
            ...
            return (
              ...
              >
                ...
                <div className="w-[330px] shrink-0 px-4 py-3.5">
                  <div className="min-w-0">
                  ...
                  <div className="mt-3 flex flex-wrap items-center gap-1.5">
                    <button
                      ...
                      className="inline-flex rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs font-bold text-blue-700 transition hover:bg-blue-100"
                    >
                      Analyse
                    </button>
                    ...
                    <button
                      ...
                      className="inline-flex rounded-full border border-green-200 bg-green-50 px-3 py-1 text-xs font-bold text-green-700 transition hover:bg-green-100"
                    >
                      Energie
                    </button>
